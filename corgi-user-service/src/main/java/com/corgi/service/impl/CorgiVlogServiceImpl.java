...
public class CorgiVlogServiceImpl implements CorgiVlogService {
    ...
    @Override
    public List<CorgiVlog> recallBarVlog(CorgiVlog corgiVlog, Integer limit) {
        return corgiVlogMapper.recallBarVlog(corgiVlog, limit);
    }
    ...
    @Override
    public List<CorgiVlog> listHotVlog(CorgiVlog corgiVlog, Integer page, Integer limit) {
        return corgiVlogMapper.listHotVlog(corgiVlog, (page - 1) * limit, limit);
    }
    ...
    @Override
    public List<CorgiVlog> recallFollowedVlog(CorgiVlog corgiVlog, Integer limit) {
        return corgiVlogMapper.recallFollowedVlog(corgiVlog.getUserId(), limit, UserUtils.getIndex(corgiVlog.getUserId()));
    }
    ...
    @Override
    public CorgiVlog countByHashtag(String hashtagId, String type) {
