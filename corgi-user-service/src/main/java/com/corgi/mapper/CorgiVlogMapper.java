...
public interface CorgiVlogMapper {
    ...
    List<String> getUserActivity(@Param("activityId") String activityId, @Param("size") Integer size);
    ...
    List<CorgiVlog> listHotVlog(@Param("vlog") CorgiVlog corgiVlog, @Param("start") Integer start, @Param("size") Integer size);
